...
fp1 = open("C:\\Users\\Tiago\\PycharmProjects\\Automatic-Text-Scoring\\webapp\\models\\glove.6B.300d.txt", "r",
           encoding='utf-8')
glove_emb = {}
for line in fp1:
    temp = line.split(" ")
...
def SKIPFLOW(embedding_matrix, vocab_size, lstm_dim=50, lr=1e-4, lr_decay=1e-6, k=5, eta=3, delta=50, activation="relu",
             maxlen=MAX_SEQUENCE_LENGTH, seed=None):
...
def init(essay_type='4'):
    ...
    fp = open("C:\\Users\\Tiago\\PycharmProjects\\Automatic-Text-Scoring\\webapp\\models\\training_set_rel3.tsv", 'r',
    ...
    sf_1 = SKIPFLOW(embedding_matrix, vocab_size, lstm_dim=50, lr=2e-4, lr_decay=2e-6, k=4, eta=13, delta=50,
                    activation="relu", seed=None)

    sf_1.load_weights(
        "C:\\Users\\Tiago\\PycharmProjects\\Automatic-Text-Scoring\\webapp\\models\\weights/" + str(
            essay_type) + "_weights.h5")
